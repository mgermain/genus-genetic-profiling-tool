...
public class Prop_Sequences extends AbsolutePanel {
    ...
    private void init() {
        // //////
        // BLAH BLAH FAIRE QUE je passe prop sequence a la class PROP
        // //////
        clear();
        ...
        final ChangeHandler nameChangeHandler = new ChangeHandler() {
            ...
            public void onChange(ChangeEvent event) {
                Prop_Sequences.this.rnass.setName(Prop_Sequences.this.txtName.getText());
            }
        };
        ...
        final ChangeHandler dpChangeHandler = new ChangeHandler() {
            ...
            public void onChange(ChangeEvent event) {
                try {
                    Prop_Sequences.this.rnass.setRNAssDotParentheses(Prop_Sequences.this.txtDp.getText(), Prop_Sequences.this.txtNuc.getText());
                } catch (final RNAException e) {
                    // TODO dire un erreur
                    Prop_Sequences.this.txtDp.setText(Prop_Sequences.this.rnass.getDotParentesis());
                }
            }
        };
        ...
        final ChangeHandler colorChangeHandler = new ChangeHandler() {
            @Override
            public void onChange(ChangeEvent event) {
                Prop_Sequences.this.rnass.setColor(Color.getColor(Prop_Sequences.this.lbColor.getValue(Prop_Sequences.this.lbColor.getSelectedIndex())));
            }
        };
        ...
        final ChangeHandler styleChangeHandler = new ChangeHandler() {
            @Override
            public void onChange(ChangeEvent event) {
                Prop_Sequences.this.rnass.setDrawStyle(RNAssDrawable.DrawStyle.valueOf(Prop_Sequences.this.lbStyle.getValue(Prop_Sequences.this.lbStyle.getSelectedIndex())));
            }
        };
